...
def evaluate(model, loss_fn, dataloader, metrics, params):
    ...
    for batch in dataloader:
        data_batch, labels_batch,target_landmark = batch['image'],batch['labels'],batch['landmark']
        ...
        output_batch,landmark = model(data_batch)
...
if __name__ == '__main__':
    ...
    datas['test'] = (X_test, y_test)
    # fetch dataloaders
    dataloaders = data_loader.fetch_dataloader(['test'], datas, params)
