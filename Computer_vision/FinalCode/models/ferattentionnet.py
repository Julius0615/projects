...
__all__ = ['FERAttentionNet', 'ferattention']
...
class AttentionResNet(nn.Module):
    ...
    def __init__(self, in_channels=3, out_channels=1, num_filters=32, encoder_depth=18, pretrained=True):
        ...
        if encoder_depth ==18:
            ...
            bottom_channel_nr =self.encoder.fc.in_features
...
class FERAttentionNet(nn.Module):
    ...
    def __init__(self, dim=32, num_classes=7, num_channels=3, num_filters=32 ):
        ...
        self.netclass_18 = torchvision.models.resnet18()
        self.netclass_18.fc = nn.Linear(self.netclass_18.fc.in_features,7)
        self.input_size = 128
